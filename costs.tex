...
Au final, nous arrivons à une formule empirique pour l'étape de métallisation (avec $c$ le coût par pièce et $n$ le nombre de pièce sur un rack) :
...
\begin{figure}[h]
    ...
    \begin{tikzpicture}
        \pie[sum=auto,text=legend, after number=\si{\chf}]{1.33/Injection, 0.47/Activation, 0.70/Métallisation}
    \end{tikzpicture}
    \begin{center}
        \caption{Pièce d'exemple. Les dimensions et la géométrie sont approximatives.}\label{fig:example-part}
    \end{center}
